      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#1a5f3f] text-white p-8 md:p-12 lg:p-16 flex flex-col justify-center">
        <div className="max-w-lg">
          ...
          <p className="text-lg md:text-xl text-white/90 leading-relaxed">
            Jump into the career journey with <strong>opportunities</strong>, <strong>networking</strong>, and <strong>other resources</strong> — plus career-boosting tips to kickstart or grow your professional success.
          </p>
        </div>
      </div>
              ...
              {({ isSubmitting, errors, touched }) => (
                <Form className="space-y-6">
                  ...
                  <p className="text-xs text-gray-600 text-center">
                    By clicking Sign in you agree to JobHire's{' '}
                    <Link href="/terms" className="underline hover:text-gray-800">Terms of Service</Link>,{' '}
                    <Link href="/privacy" className="underline hover:text-gray-800">Privacy Policy</Link> and{' '}
                    <Link href="/intellectual-property" className="underline hover:text-gray-800">Intellectual Property Policy</Link>.
                  </p>

                  {/* Sign Up Link */}
                  <p className="text-sm text-gray-600 text-center mt-4">
                    Already have an account?{' '}
                    <Link href="/login" className="underline hover:text-gray-800 font-medium">
                      Sign in
                    </Link>
                  </p>
                </Form>
